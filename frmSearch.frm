...
If Not cboField.Text = "" Then
    If Not cboCrieria.Text = "" Then
        If Not cboCrieria.Text = "Between" And Not cboCrieria.Text = "Like" Then
            sql = "Select distinct p_code,p_name,S_no  from ag_products where " & cboField.Text & "" & cboCrieria.Text & "'" & txtFrom.Text & "'"
           CConnect.Openrs
        ...
        ElseIf cboCrieria.Text = "Like" Then
            ...
            sql = "Select distinct p_code,p_name,S_no from ag_products order by P_code"
           CConnect.Openrs
        ...
        Else
            If cboField.Text = "Amount" Then
                sql = "select distinct p_code,p_name,S_no  from products where " & cboField.Text & " " & cboCrieria & " " & txtFrom.Text & " And " & txtTo.Text & ""
               CConnect.Openrs
            Else
                sql = "select distinct p_code,p_name,S_no  from products where " & cboField.Text & " " & cboCrieria & " '" & txtFrom.Text & "' And '" & txtTo.Text & "'"
               CConnect.Openrs
...
Set CConnect = New MAZIWA.CConnect
    ...
    CConnect.cnnConnect
    sql = "Select distinct p_code,p_name,S_no  from ag_Products order by P_NAME"
    CConnect.Openrs
...
lstSearch.ListItems.Clear
    ...
    CConnect.cnnConnect
    sql = "Select distinct* from products order by P_code"
    CConnect.Openrs
