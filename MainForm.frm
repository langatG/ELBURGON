...
Begin VB.MDIForm MainForm 
   ...
   Begin VB.Menu mnutransactions 
      ...
      Begin VB.Menu mnuagrovet 
         ...
         Begin VB.Menu mnuSales 
            Caption         =   "Sales"
         End
         Begin VB.Menu mnuproductremoval 
   ...
   Begin VB.Menu mnuSetUp 
      ...
      Begin VB.Menu mnuPricing 
         ...
         End
         Begin VB.Menu mnubonuspricings 
            Caption         =   "Bonus Price"
         End
      End
   ...
   Begin VB.Menu mnuReports 
      ...
      Begin VB.Menu mnuTPayroll 
         ...
         Enabled         =   0   'False
      End
      Begin VB.Menu mnusuppliersreportss 
         ...
         End
         Begin VB.Menu mnusupbonusstatement 
            Caption         =   "Bonus Statement"
         End
         Begin VB.Menu mnusharesstatements 
      ...
      Begin VB.Menu mnuGeneralsharesreport 
         ...
         Begin VB.Menu mnuGeneralshares 
            ...
            Visible         =   0   'False
         End
         Begin VB.Menu mnusharesRe 
            Caption         =   "Shares Report"
            Visible         =   0   'False
         End
         Begin VB.Menu mnutotalshares 
            Caption         =   "Total Shares Report"
         End
      End
...
Private Sub mnuproductremoval_Click()
 'check the user
...
'****************'
frmproductdisposal.Show vbModal
End Sub
...
Private Sub mnurecivstock_Click()
    ...
    reportname = "stockreceivelist.rpt"
    Show_Sales_Crystal_Report "", reportname, ""
End Sub
...
Private Sub mnusharesRe_Click()
reportname = "Totalshares1.rpt"
 Show_Sales_Crystal_Report "", reportname, ""
End Sub

Private Sub mnusharesstatements_Click()
frmSuppliersStmtShares.Show vbModal
...
Private Sub mnustockba_Click()
    ...
    reportname = "newstockbalances.rpt"
    Show_Sales_Crystal_Report STRFORMULA, reportname, ""
End Sub
...
Private Sub mnusupbonusstatement_Click()
frmSupplierStmtBonus.Show vbModal
End Sub
...
Private Sub mnutotalshares_Click()
'reportname = "TotalsharesSUM.rpt"
